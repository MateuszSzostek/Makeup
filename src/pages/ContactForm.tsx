      ...
      <div className="contact-grid justify-center relative"> 
        <div className="col w-100prec z-index-20">
          <form  action="https://formspree.io/f/xyybowbj" method="POST" className="flex col contact-form ">
            ...
            <button className="border-shadow btn-hover transition-03 pointer w-150 h-36 border-none my-15 text-base border-radius-10 bg-purple-tr50">{intl.formatMessage({ id: "send" })}</button>
          </form>
        </div>
        <div className="col flex w-100prec z-index-20 justify-center align-center text-center">
          ...
          <p className="my-10 text-base">Email Address</p>
          <p className="my-10 text-base">+ 48 0378509378</p>
          <p className="my-10 text-base">08:00 - 15:00</p>
        </div>
